package com.example.formador.myanimationapp2;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*Animation a = AnimationUtils.loadAnimation(this, R.anim.animation_view);
        tv.startAnimation(a);*/

        //ANIMATION PROPERTY OBJECTANIMATOR
        /*ValueAnimator va = (ValueAnimator) AnimatorInflater.loadAnimator(this, R.animator.animacion_property_object);
        va.setTarget(tv);
        va.start();*/

        //ANIMATION PROPERTY VALUEANIMATOR
        /*ValueAnimator va1 = (ValueAnimator)AnimatorInflater.loadAnimator(this, R.animator.animacion_property_animator);
